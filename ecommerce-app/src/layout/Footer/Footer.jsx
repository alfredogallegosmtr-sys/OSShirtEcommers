            ...
            <div className="footer-content">
              ...
              <div className="footer-section">
                ...
                <p className="footer-description">
                  Tu tienda de camisetas de anime, manga y cultura japonesa,
                  coreana y china. Diseños originales, algodón de calidad y
        ...
        <div className="container">
          <div className="footer-bottom-content">
            <p className="copyright">
              &copy; {new Date().getFullYear()} OSShirts. Todos los derechos
              reservados.
            </p>
