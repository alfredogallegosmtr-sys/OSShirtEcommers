...
|---|---|---|---|---|---|---|---|---|---|
| AUTH-001 | Registro | Registro exitoso | No | Sí | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso, sin ejecutar) |
| AUTH-002 | Registro | Correo duplicado | No | Sí | Sí | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| AUTH-003 | Registro | Campos requeridos vacíos | No | No | Sí | No | Sí | Media | Implementado (E2E: En progreso) |
| AUTH-004 | Login | Login exitoso + token | No | Sí | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso) |
| AUTH-005 | Login | Credenciales incorrectas | No | Sí | Sí | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| AUTH-006 | Login | Email/password faltantes → 422 | No | Sí | No | No | No | Media | Implementado |
| AUTH-007 | Login | Persistencia de sesión (reload) | No | No | No | Sí | Sí | Alta | Implementado (E2E: En progreso) |
...
| AUTH-010 | Rutas protegidas | Redirección a `/login` sin sesión | No | No | Sí | No | Sí | Alta | Implementado (E2E: En progreso) |
...
| CART-001 | Carrito | Agregar producto | No | Sí | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso) |
| CART-002 | Carrito | Modificar cantidad | No | Sí | Sí | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| CART-003 | Carrito | Eliminar producto | No | Sí | Sí | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| CART-004 | Carrito | Cálculo de subtotal/total | No | Sí (vía `recalcTotal`) | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso) |
...
| ADDR-001 | Direcciones | Crear dirección válida | No | Sí | Sí | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| ADDR-002 | Direcciones | Campos requeridos vacíos → 422 | No | Sí | Sí | No | Sí | Media | Implementado (E2E: En progreso) |
...
| PAY-001 | Métodos de pago | Crear método válido (solo `last4`, nunca número completo) | No | Sí | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso) |
...
| ORD-001 | Órdenes | Crear orden con carrito válido | No | Sí | Sí | Sí | Sí | Crítica | Implementado (E2E: En progreso) |
| ORD-002 | Órdenes | Cálculo de totales (IVA 16%, envío $350/gratis ≥$1000) | No | Sí | Sí | No | Sí | Crítica | Implementado (E2E: En progreso) |
| ORD-003 | Órdenes | Carrito vacío → 422 | No | Sí | Sí | No | Sí | Alta | Implementado (E2E: En progreso) |
| ORD-004 | Órdenes | Dirección/método de pago inexistente o de otro usuario → 404 | No | Sí | No | No | No | Alta | Implementado |
| ORD-005 | Órdenes | Vaciar carrito tras crear la orden | No | Sí | No | Sí | Sí | Alta | Implementado (E2E: En progreso) |
| ORD-006 | Órdenes | Doble clic no crea dos órdenes (B-15) | No | No | No | Sí (regresión) | Sí | Alta | Implementado (E2E: En progreso) |
...
- **En progreso** (columna E2E, todas las filas con Cypress): las 20 specs están escritas y
  verificadas por Playwright, pero nunca ejecutadas con el runner real de Cypress en esta máquina
  — ver "Errores conocidos" en [known-issues.md](known-issues.md).
