...
| E5 | Limpieza de bugs y código muerto detectados en la auditoría | **Cerrado (2026-08-31)** — B-01 a B-18, sin items pendientes (B-18 reabrió el epic: causa raíz más profunda del mismo flake que motivó B-16) | _(pendiente)_ |
