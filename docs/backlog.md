...
| E5 | Limpieza de bugs y código muerto detectados en la auditoría | **Cerrado (2026-09-01)** — B-01 a B-19, sin items pendientes (B-19 reabrió el epic: `Header` sin `ErrorBoundary` propio, encontrado al revisar una referencia externa de error boundaries contra el código real) | _(pendiente)_ |
